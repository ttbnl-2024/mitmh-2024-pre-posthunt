...
import RoundTheme from 'components/themes/themes';
import VolumeSlider from 'components/volume_slider';

import Round from 'pages/rounds/[slug]';
...
const Layout: React.FC<Props> = ({ children }) => {
  ...
  const themeStyle = <RoundTheme roundSlug={round.slug} />;
        ...
        >
          ...
          <div className="nav-list">
            <ul className="inline-flex">
              <NavbarLink href="/" linkText="Underworld" />
              {teamInfo?.overworld && (
                <NavbarLink href="/overworld" linkText="Overworld" />
              )}
              {!(prehunt && !userInfo?.staff) && teamInfo?.rounds && (
                <NavbarLink
                  linkText="Rounds"
                  dropdownItems={
              ...
              <NavbarLink
                linkText="Hunt"
                dropdownItems={[
                  ...(prehunt && !userInfo?.staff
                    ? []
                    : [[{ href: '/puzzles', linkText: 'List of Puzzles' }]]),
                  [
                    ...(prehunt && !userInfo?.staff
                      ? []
                      : [{ href: '/oracle', linkText: 'Oracle' }]),
