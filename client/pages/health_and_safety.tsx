...
const HQ_EMAIL = 'info@mitmh2024.com';

const HealthAndSafety = () => {
  return (
    <>
      <div className="max-w-[1200px] md:mt-10 mx-auto">
        <Section className="bg-white">
          <Title title="Health & Safety" />

          <div id="content">
            <p>
              Ensuring the health and safety of all Mystery Hunt participants is
              a top priority. As the leaders of your teams, you are primarily
              responsible for handling emergencies and for ensuring the overall
              health and safety of team members (or designating a responsible
              team member for that role).
            </p>
            <p>
              This document contains important information and helpful tips.
            ...
            <Section heading="Use Common Sense">
              <ul>
                <li>
                  ...
                  risk of being harmed, arrested, or held liable for any
                  property damage. Our actions will also reflect on the Mystery
                  Hunt as a whole, so let's stay safe and responsible both for
                  our own sakes and for the sake of everyone who loves the
                  Mystery Hunt and cares about its future.
                </li>
                <li>
                  <b>Follow our instructions.</b> During hunt, we will
                  communicate any important health and safety information on the
                  hunt website, by e-mail, by phone, and in person if needed.
                </li>
                <li>
            ...
            <Section heading="Important Contact Information">
              <ul>
                <li>
                  ...
                  whether they are of a criminal, medical, or safety nature, or
                  to report an encounter with a suspicious or dangerous person
                  who is not participating in the hunt. The MIT Police will
                  dispatch the appropriate resources, which in some cases might
                  include the student-run MIT-EMS, who will have an ambulance on
                  call.
                </li>
                <li>
                  <b>Hunt HQ Phone: &nbsp;617-324-7732.</b> &nbsp;Call during
                  hunt if you encounter a “real-life situation” and you do not
                  know what to do (minor medical issue, lost team member,
                  encounter with police, damage to MIT property, etc.).
                </li>
                <li>
            ...
            <Section heading="Alerts">
              <ul>
                <li>
                  ...
                  emergencies on campus. We will add at least one contact per
                  team just for Hunt weekend (via the Health &amp; Safety Quiz);
                  to subscribe permanently, visit{' '}
            ...
            <Section heading="Medical Care">
              <ul>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      Overnight, call MIT Medical at 617-253-4481 to speak with
                      a nurse, who can schedule a next-day appointment.
                    </li>
                    <li>
                ...
                <li>
                  <b>First Aid:&nbsp;</b> Hunt HQ will provide a kit to each
            ...
            <Section heading="Know Where You Are">
              <ul>
                <li>
                  ...
                  only thing happening. Try not to disturb researchers, staff,
                  and other activities that might be occurring on campus.
                </li>
                <li>
                  <b>Don’t go anywhere or do anything illegal or unsafe.</b>{' '}
                  Mystery Hunt takes place in specified rooms and campus
                  locations accessible to the MIT community at large. Don’t
                  attempt to enter other spaces, except locations where events
                  are scheduled or that Hunt personnel explicitly provide access
                  to. Don’t force open locked doors or set off emergency alarms.
                </li>
                <li>
                  <b>
                    Don’t carry any weapon, or anything that looks like a
                    weapon, on campus.
                  </b>
                </li>
                <li>
                  <b>Be careful with MIT property</b>, especially if your team
                  is using an MIT room as its base. Damage to property will
                  reflect poorly on the Mystery Hunt in general and will
                  compromise your team’s ability to use MIT rooms in the future.
                </li>
                <li>
                  <b>Team members may not know MIT’s campus well.</b> Before
                  sending team members on an excursion, you should ensure you
                  can stay in touch with them (and vice versa). If needed,
                  provide team members with maps.{' '}
                ...
                <li>
                  ...
                  If that fails, call Hunt HQ, and if we cannot help, contact
                  MIT Police.
                </li>
              </ul>
            </Section>
            <Section heading="Stay Healthy">
              <ul>
                ...
                <li>
                  ...
                  <b>plan for getting sleep</b>. &nbsp;“Work until burnout” is
                  not a winning strategy. Getting sleep is important — Mystery
                  Hunt is a marathon, not a sprint.
                  <ul>
                    <li>
                      <b>
                      ...
                      Make appropriate arrangements so that team members can
                      sleep in dorms, hotels or nearby residences. Dorm
                      residents hosting hunters should adhere to the guest
                      policies of their residence halls.
                    </li>
                    <li>
                      <b>
                        MIT does not allow visitors to access campus between 1
                        AM and 6 AM.
                      </b>{' '}
                ...
                <li>
                  ...
                  available nearby in Kendall Square, Central Square, and the
                  MIT Student Center.
                </li>
                <li>
                  <b>No alcohol or drugs</b> on campus. Possession or
                  consumption of alcohol or drugs in classrooms or in public MIT
                  campus spaces (except pubs) is strictly prohibited. This
                  policy applies even if everyone on your team is of legal
                  drinking age.
                </li>
              </ul>
            </Section>
            <Section heading="Minors">
              <ul>
                <li>
                  Minors may attend or participate in Mystery Hunt from
                  on-campus locations between the hours of 6:00 AM and 1:00 AM.
                </li>
                <li>
                  <b>
                ...
                <li>
                  If you need to interact with an unsupervised minor, have
                  another adult present and conduct those interactions in a
                  public environment where you can be observed.
                </li>
                <li>
                  The full{' '}
                  <a href="https://docs.google.com/document/d/1SUdGC5DV97YKieOd8TwNV_d1HiIoqlWQ4P2EcI4wTcA/edit">
                    Regulations Regarding the Presence and Participation of
                    Minors
                  </a>{' '}
          ...
          "
            >
              <ul>
                <li>
                  The MIT Mystery Hunt is dedicated to providing a
                  ...
                  form. Participants asked to stop any harassing behavior are
                ...
                <li>
                  ...
                  from the uncomfortable situation and contact Hunt HQ by email
                  at <a href={'mailto:' + HQ_EMAIL}>{HQ_EMAIL}</a>.
                ...
                <li>
                  Team captains should make sure this policy is understood by
                  all team members and should actively discourage harassment
