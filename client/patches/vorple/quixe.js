...
window.Quixe = function () {
    ...
    */
    var opcode_table = {
        0x0: function (context, operands) {
        },
        0x10: function (context, operands) {
        ...
        0x11: function (context, operands) {
            /* We hold operand 0, to ensure that it's evaluated first. Op 1
               is an expression. */
            context.code.push(operands[2] + "((" + operands[0] + ")-(" + operands[1] + ")) >>>0);");
        },
        0x12: function (context, operands) {
        ...
        0x13: function (context, operands) {
            var sign0 = oputil_signify_operand(context, operands[0]);
            var sign1 = oputil_signify_operand(context, operands[1]);
            var holdvar = alloc_holdvar(context);
        ...
        0x14: function (context, operands) {
        ...
        0x15: function (context, operands) {
            context.code.push(operands[1] + "(-(" + operands[0] + ")) >>>0);");
        },
        0x18: function (context, operands) {
            /* Commutative. */
            context.code.push(operands[2] + "((" + operands[0] + ")&(" + operands[1] + ")) >>>0);");
        },
        0x19: function (context, operands) {
            /* Commutative. */
            context.code.push(operands[2] + "((" + operands[0] + ")|(" + operands[1] + ")) >>>0);");
        },
        0x1a: function (context, operands) {
            /* Commutative. */
            context.code.push(operands[2] + "((" + operands[0] + ")^(" + operands[1] + ")) >>>0);");
        },
        0x1b: function (context, operands) {
            context.code.push(operands[1] + "(~(" + operands[0] + ")) >>>0);");
        },
        0x1c: function (context, operands) {
        ...
        0x1d: function (context, operands) {
            if (quot_isconstant(operands[1])) {
                var val = Number(operands[1]);
                if (val < 32)
                    context.code.push(operands[2] + "((" + operands[0] + ")>>" + val + ") >>>0);");
        ...
        0x1e: function (context, operands) {
            if (quot_isconstant(operands[1])) {
                var val = Number(operands[1]);
                if (val < 32)
        ...
        0x27: function (context, operands) {
            var sign0 = oputil_signify_operand(context, operands[0]);
            var sign1 = oputil_signify_operand(context, operands[1]);
            context.code.push("if ((" + sign0 + ")>=(" + sign1 + ")) {");
            oputil_perform_jump(context, operands[2]);
        ...
        0x28: function (context, operands) {
            var sign0 = oputil_signify_operand(context, operands[0]);
            var sign1 = oputil_signify_operand(context, operands[1]);
            context.code.push("if ((" + sign0 + ")>(" + sign1 + ")) {");
            oputil_perform_jump(context, operands[2]);
        ...
        0x29: function (context, operands) {
            var sign0 = oputil_signify_operand(context, operands[0]);
            var sign1 = oputil_signify_operand(context, operands[1]);
            context.code.push("if ((" + sign0 + ")<=(" + sign1 + ")) {");
            oputil_perform_jump(context, operands[2]);
        ...
        0x2a: function (context, operands) {
            context.code.push("if ((" + operands[0] + ")<(" + operands[1] + ")) {");
            oputil_perform_jump(context, operands[2]);
            context.code.push("}");
        },
        0x2b: function (context, operands) {
            context.code.push("if ((" + operands[0] + ")>=(" + operands[1] + ")) {");
            oputil_perform_jump(context, operands[2]);
            context.code.push("}");
        },
        0x2c: function (context, operands) {
            context.code.push("if ((" + operands[0] + ")>(" + operands[1] + ")) {");
            oputil_perform_jump(context, operands[2]);
            context.code.push("}");
        },
        0x2d: function (context, operands) {
            context.code.push("if ((" + operands[0] + ")<=(" + operands[1] + ")) {");
            oputil_perform_jump(context, operands[2]);
            context.code.push("}");
        },
        0x30: function (context, operands) {
            if (quot_isconstant(operands[1])) {
                var ix;
        ...
        0x34: function (context, operands) {
            if (quot_isconstant(operands[1])) {
                var ix;
                var argc = Number(operands[1]);
                for (ix = 0; ix < argc; ix++) {
        ...
        0x160: function (context, operands) {
            oputil_unload_offstate(context);
        ...
        0x161: function (context, operands) {
            oputil_unload_offstate(context);
        ...
        0x162: function (context, operands) {
            oputil_unload_offstate(context);
            context.code.push("self.tempcallargs[0]=(" + operands[1] + ");");
        ...
        0x163: function (context, operands) {
            oputil_unload_offstate(context);
            context.code.push("self.tempcallargs[0]=(" + operands[1] + ");");
            context.code.push("self.tempcallargs[1]=(" + operands[2] + ");");
        ...
        0x31: function (context, operands) {
        ...
        0x32: function (context, operands) {
            oputil_unload_offstate(context);
        ...
        0x33: function (context, operands) {
        ...
        0x40: function (context, operands) {
            oputil_store(context, operands[1], operands[0]);
        },
        0x41: function (context, operands) {
            oputil_store(context, operands[1], operands[0]);
        },
        0x42: function (context, operands) {
            oputil_store(context, operands[1], operands[0]);
        },
        0x44: function (context, operands) {
            var val;
            if (quot_isconstant(operands[0])) {
        ...
        0x45: function (context, operands) {
            var val;
            if (quot_isconstant(operands[0])) {
                val = Number(operands[0]);
        ...
        0x48: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
        ...
        0x49: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
                    /* Both operands constant */
        ...
        0x4a: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
                    /* Both operands constant */
        ...
        0x4c: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
                    /* Both operands constant */
        ...
        0x4d: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
                    /* Both operands constant */
        ...
        0x4e: function (context, operands) {
            var val, addr;
            if (quot_isconstant(operands[1])) {
                if (quot_isconstant(operands[0])) {
                    /* Both operands constant */
        ...
        0x4b: function (context, operands) {
            if (quot_isconstant(operands[1])) {
        ...
        0x4f: function (context, operands) {
        ...
        0x50: function (context, operands) {
            var val;
        ...
        0x51: function (context, operands) {
            var val;
            if (quot_isconstant(operands[0])) {
        ...
        0x52: function (context, operands) {
            var temp, len;
        ...
        0x53: function (context, operands) {
            oputil_unload_offstate(context);
            context.varsused["ix"] = true;
        ...
        0x54: function (context, operands) {
            oputil_unload_offstate(context);
            if (quot_isconstant(operands[0])) {
                var ix, holdvar;
                var pos = Number(operands[0]);
        ...
        0x110: function (context, operands) {
            var expr;
        ...
        0x111: function (context, operands) {
            context.code.push("self.set_random(" + operands[0] + ");");
        },
        0x120: function (context, operands) {
        ...
        0x121: function (context, operands) {
            context.code.push(operands[0] + "self.perform_verify());");
        },
        0x122: function (context, operands) {
            /* Quash the offstack. No more execution. */
            ;
            ;
            ;
        ...
        0x123: function (context, operands) {
            oputil_unload_offstate(context);
            context.varsused["ix"] = true;
            oputil_push_callstub(context, operands[1]);
        ...
        0x124: function (context, operands) {
            oputil_unload_offstate(context);
        ...
        0x125: function (context, operands) {
            oputil_unload_offstate(context);
            oputil_push_callstub(context, operands[0]);
        ...
        0x126: function (context, operands) {
            oputil_unload_offstate(context);
        ...
        0x127: function (context, operands) {
        ...
        0x170: function (context, operands) {
        ...
        0x171: function (context, operands) {
        ...
        0x178: function (context, operands) {
        ...
        0x179: function (context, operands) {
        ...
        0x180: function (context, operands) {
        ...
        0x70: function (context, operands) {
        ...
        0x71: function (context, operands) {
            switch (context.curiosys) {
                case 2: /* glk */
                    var sign0 = oputil_signify_operand(context, operands[0]);
                    if (quot_isconstant(operands[0])) {
        ...
        0x72: function (context, operands) {
        ...
        0x73: function (context, operands) {
            switch (context.curiosys) {
                case 2: /* glk */
                    if (quot_isconstant(operands[0])) {
        ...
        0x190: function (context, operands) {
            var sign0 = oputil_signify_operand(context, operands[0]);
            if (quot_isconstant(operands[0])) {
        ...
        0x191: function (context, operands) {
        ...
        0x192: function (context, operands) {
            context.varsused["valf"] = true;
            context.varsused["res"] = true;
            context.code.push("valf = " + oputil_decode_float(context, operands[0]) + ";");
            context.code.push("if (!(" + operands[0] + " & 0x80000000)) {");
        ...
        0x1A1: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push(operands[2] + "self.encode_float(" + valf0 + " - " + valf1 + "));");
        },
        0x1A2: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push(operands[2] + "self.encode_float(" + valf0 + " * " + valf1 + "));");
        },
        0x1A3: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push(operands[2] + "self.encode_float(" + valf0 + " / " + valf1 + "));");
        },
        0x1A4: function (context, operands) {
        ...
        0x1C1: function (context, operands) {
            var val, valf0, valf1, valf2;
            context.varsused["fequal"] = true;
            context.varsused["fdiff"] = true;
            context.code.push("if ((" + operands[2] + " & 0x7f800000) == 0x7f800000 && (" + operands[2] + " & 0x007fffff) != 0) {");
        ...
        0x1C2: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
        ...
        0x1C3: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push("if (" + valf0 + " <= " + valf1 + ") {");
            oputil_perform_jump(context, operands[2]);
        ...
        0x1C4: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push("if (" + valf0 + " > " + valf1 + ") {");
            oputil_perform_jump(context, operands[2]);
        ...
        0x1C5: function (context, operands) {
            var valf0 = oputil_decode_float(context, operands[0]);
            var valf1 = oputil_decode_float(context, operands[1]);
            context.code.push("if (" + valf0 + " >= " + valf1 + ") {");
            oputil_perform_jump(context, operands[2]);
    ...
    */
    function compile_path(vmfunc, startaddr, startiosys) {
        ...
        while (!context.path_ends) {
            ...
            ;
            if (context.offloc.length)
                context.code.push("// offloc: " + context.offloc.join(",") + "; dirty: " + context.offlocdirty.join(",")); //debug
    ...
    */
    ...
    function linear_search(key, keysize, start, structsize, numstructs, keyoffset, options) {
    ...
    function binary_search(key, keysize, start, structsize, numstructs, keyoffset, options) {
    ...
    function linked_search(key, keysize, start, keyoffset, nextoffset, options) {
        var ix, byt, match;
        var zeroterm = ((options & 2) != 0);
        var keybuf = fetch_search_key(key, keysize, options);
        while (start != 0) {
