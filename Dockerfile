...
# build caddy
FROM caddy:2.6.4-builder-alpine as caddy_builder
ENV CADDY_VERSION 0db29e2ce9799f652f3d16fd5aed6e426d23bd0a
...
COPY client/package.json client/yarn.lock client/patch.sh ./
