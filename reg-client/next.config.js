...
const IS_ARCHIVE = !!Number(process.env.ENABLE_POSTHUNT_SITE); // whether to use /2024/... path scheme for posthunt
...
// FIXME: Update prefix
const STORAGE_PREFIX = '2024-'; // for cookies and localStorage
...
const SECRET_KEY_POSTFIX = 'SECRET_KEY_I_PROMISE_THIS_WAS_SET_IN_PROD';
...
const basePath =
  ...
  ? '/2024/registration.mypuzzlehunt.com'
  : '';
...
module.exports = {
  ...
  env: {
    ...
    domainName: process.env.REGISTRATION_HOST || "mitmh2024.com",
    FILENAME_HASH_LENGTH,
  },
