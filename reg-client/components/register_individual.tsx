...
// TODO: update to check hunt start date // registration closing
const INDIVIDUAL_REGISTRATION_CLOSED = true;
...
const RegisterIndividual = ({
  ...
  if (!isLoggedIn && INDIVIDUAL_REGISTRATION_CLOSED)
    return <IndividualRegistrationClosed />;
      ...
      {isLoggedIn ? (
        <div className="bg-off-white p-6">
          <span className="space-y-4">
            <p>Thanks for your interest in Mystery Hunt 2024! What's next:</p>
            <p>
        ...
        <>
          ...
          {INDIVIDUAL_REGISTRATION_CLOSED ? (
              ...
              <div className="flex flex-col space-y-16">
                <section>
                  <FormRow
                    ...
                    label="First (Given) name or nickname"
