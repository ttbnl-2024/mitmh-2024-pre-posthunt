...
import constellation from 'assets/public/constellation-example.jpg';
import stars1 from 'assets/public/stars-1.jpg';
import stars2 from 'assets/public/stars-2.jpg';
import stars3 from 'assets/public/stars-3.jpg';
...
interface RegisterTeamForm {
  ...
  other_how?: string;
  other?: string;
  constellation_pic?: string;
  constellation_pic_url?: string;
}

interface RegisterTeamResp {
  constellation_pic_url?: string;
}
...
export const useTeamRegistrationInfo = (
  ...
  isLoading: boolean;
  registrationInfo: RegisterTeamForm;
  setRegistrationInfo: Dispatch<SetStateAction<RegisterTeamForm>>;
} => {
  ...
  if (!loggedInSlug) {
    return { isLoading: false, registrationInfo: {}, setRegistrationInfo };
  }
...
const RegisterTeam = ({
  ...
  const { isLoading, registrationInfo, setRegistrationInfo } =
    useTeamRegistrationInfo(loggedInSlug);
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const resp = await clientFetch<
        DjangoFormResponse<RegisterTeamForm, RegisterTeamResp>
      >(router, path, {
        method: 'POST',
        body: data,
        config: {
      ...
      if (!resp?.form_errors) {
        registrationInfo.constellation_pic_url =
          resp.data?.constellation_pic_url;
        setRegistrationInfo(registrationInfo);
  ...
  // Uncomment to close registration
      ...
      {loggedInSlug ? (
        <div className="bg-off-white p-6">
          <span className="space-y-4">
            <p>You're signed up for the 2024 MIT Mystery Hunt! What's next:</p>
            <p>
            ...
            <p className="flex md:space-x-8">
              <Link href="/register">See our other attendees</Link>
        ...
        <>
          <p>
            This is the registration form for the Mystery Hunt 2024. Please have
            only one person on your team fill this form out!
          </p>
          <p>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col space-y-16">
            ...
            <section>
              ...
              <p>Help us understand your team better.</p>
              <FormRow
                name="bg_playstyle"
            ...
            <section>
              ...
              <FormRow
                ...
                info="If you need a classroom to use as a team base, you may request a room through this form by December 31."
                options={{
            ...
            <section>
              ...
              <div className="space-y-4 mt-4">
                <p>
                  As part of your registration, we are asking for your input and
                  assistance! We have observed some sections of the sky with our
                  telescope in need of constellations. Pick one of these sky
                  views, orient as you like, and show us a constellation you
                  see. You do not need to use all the stars. (You can click each
                  image to open in a new tab.){' '}
                  <strong>
                    This is a creative exercise, and is not a puzzle.
                  </strong>
                </p>
                ...
                <p>Here is one such constellation our intern has proposed:</p>
                <img
                  src={constellation}
                  className="mx-auto min-w-[350px] w-[30%]"
                />
              </div>
              <FormRow
                name="constellation_pic"
                label="Constellation image"
                type="file"
                errors={errors.constellation_pic}
                required={
                  registrationInfo?.constellation_pic_url == undefined ||
                  registrationInfo?.constellation_pic_url === ''
                }
              />
              {!(
                ...
                <div className="my-4">
                  <span className="font-bold">Current constellation</span>
                  <img
                    src={registrationInfo?.constellation_pic_url}
                    className="mx-auto mt-2 min-w-[350px] w-[30%]"
                  />
                </div>
              )}
            </section>
