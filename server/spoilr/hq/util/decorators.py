...
from spoilr.core.api.decorators import (
    InjectedTeamHttpRequest,
    ViewDecorator,
    ViewFunc,
    inject_team,
...
def hq(require_handler=False) -> ViewDecorator:
...
class HqHttpRequest(InjectedTeamHttpRequest):
    handler: Handler | None


class HqHandlerHttpRequest(InjectedTeamHttpRequest):
    handler: Handler
