...
def register(
    event_type: HuntEvent, subscriber, priority=HandlerPriority.MEDIUM
) -> None:
    """
...
def register_wildcard(subscriber) -> None:
...
def _dispatch_internal(event_type: HuntEvent, **kwargs):
    for subscriber, _unused_priority in map(
