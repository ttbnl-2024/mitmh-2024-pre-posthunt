...
if IS_PYODIDE:
    ...
    class FakeCelery:
        ...
        def config_from_object(self, obj, namespace=None) -> None:
            pass
    ...
    @celery_app.task(name="debug", bind=True)  # type: ignore
    def debug_task(self):
        print(f"Request: {self.request!r}")
        return "Task finished!"

    @celery_app.task(name="spoilr-tick", ignore_result=True)  # type: ignore
    def tick():
