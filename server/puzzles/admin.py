...
from puzzles.models.hydra import HydraPuzzle
...
class RoundAdmin(admin.ModelAdmin):
    list_display = ("__str__", "act", "order")
    list_filter = ["act"]
...
class TeamAdmin(admin.ModelAdmin):
    ...
    @admin.display(description="Prerel.?", boolean=True)
...
class PuzzleSubmissionAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "used_free_answer", "puzzle", "team")
